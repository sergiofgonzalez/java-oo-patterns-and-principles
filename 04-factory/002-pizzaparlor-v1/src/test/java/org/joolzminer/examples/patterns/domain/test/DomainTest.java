...
import org.joolzminer.examples.patterns.factories.SimplePizzaFactory;
...
public class DomainTest {
	...
	public void testOrderCheesePizza() {
		PizzaParlorService pizzaParlorService = new PizzaParlorService(new SimplePizzaFactory());
