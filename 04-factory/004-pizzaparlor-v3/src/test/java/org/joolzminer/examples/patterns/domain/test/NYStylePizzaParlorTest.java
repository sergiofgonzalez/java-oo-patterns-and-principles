...
public class NYStylePizzaParlorTest {
	...
	public void testOrderNYStyleCheesePizza() {
		...
		assertThat(pizza.getDescription(), is(equalTo("NYStyleCheesePizza")));
	}
	...
	public void testOrderNYStylePepperoniPizza() {
		...
		assertThat(pizza.getDescription(), is(equalTo("NYStylePepperoniPizza")));
	}
	...
	public void testOrderNYStyleVeggiePizza() {
		...
		assertThat(pizza.getDescription(), is(equalTo("NYStyleVeggiePizza")));
	}
}
