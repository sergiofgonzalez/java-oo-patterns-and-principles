...
public class ChicagoStylePizzaParlorTest {
	...
	public void testOrderChicagoStyleCheesePizza() {
		...
		assertThat(pizza.getDescription(), is(equalTo("ChicagoStyleCheesePizza")));
	}
	...
	public void testOrderChicagoStylePepperoniPizza() {
		...
		assertThat(pizza.getDescription(), is(equalTo("ChicagoStylePepperoniPizza")));
	}
	...
	public void testOrderChicagoStyleVeggiePizza() {
		...
		assertThat(pizza.getDescription(), is(equalTo("ChicagoStyleVeggiePizza")));
	}
}
