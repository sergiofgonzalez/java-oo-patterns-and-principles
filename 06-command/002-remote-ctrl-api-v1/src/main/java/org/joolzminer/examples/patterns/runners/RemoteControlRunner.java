...
import org.joolzminer.examples.patterns.command.StereoOffCommand;
...
public class RemoteControlRunner {
	...
	public static void main(String[] args) {
		...
		remoteControl.setCommand(0, new LightOnCommand(hallLight), new LightOffCommand(hallLight));
		System.out.println(remoteControl);
		...
		remoteControl.setCommand(1, new StereoOnWithCDCommand(livingRoomStereo), new StereoOffCommand(livingRoomStereo));
