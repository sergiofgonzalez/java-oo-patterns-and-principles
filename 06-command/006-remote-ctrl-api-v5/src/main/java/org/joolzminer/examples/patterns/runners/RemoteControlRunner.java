...
public class RemoteControlRunner {
	...
	public static void main(String[] args) {
		...
		remoteControl.setCommand(0, 
									...
									LightCommandHolder.lightOffFn.apply(hallLight));
		System.out.println(remoteControl);
		...
		remoteControl.setCommand(1, StereoCommandHolder.stereoOnWithCdSetFn.apply(livingRoomStereo),
									StereoCommandHolder.stereoOffWithCdSetFn.apply(livingRoomStereo));
