...
import org.joolzminer.examples.patterns.domain.CafeMenu;
...
public class MenuServices {
	...
	public void printCafeMenu() {
		...
		printMenuThroughIterator(new CafeMenu().createIterator());
	}
	...
	public void printVegetarianMenu() {
		...
		System.out.println("========== CAFE MENU =======");		
		printMenuThroughIteratorWithPredicate(new CafeMenu().createIterator(), this::isItemVegetarian);
	}
	...
	public Boolean isItemVegetarian(String itemName) {
		...
		if (!isVeg.isPresent()) {
			...
			if (!isVeg.isPresent()) {
				isVeg = findIfVegThroughIterator(itemName, new CafeMenu().createIterator());
			}
		}
